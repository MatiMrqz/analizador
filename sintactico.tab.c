...
{
      12,     0,    -1,     5,     6,     7,     3,     8,     9,     4,
      10,    -1,     5,     6,     7,     3,     9,     4,    10,    -1,
       5,     6,     7,    10,    -1,     5,     6,     7,     3,     8,
       9,     1,    10,    -1,     5,     6,     7,     3,     9,     1,
      10,    -1,     5,     6,     7,     3,     8,     1,    10,    -1,
       5,     6,     7,     3,     1,    10,    -1,     5,     6,     7,
       1,    10,    -1,     5,     6,     1,    10,    -1,     5,     1,
      10,    -1,     1,    10,    -1
};
...
{
  "$end", "error", "$undefined", "DO", "END", "LHS", "EQ", "COMMAND",
  "BLOCK_VAR", "C_STMT", "NL", "$accept", "STMT", 0
};
#endif
...
{
       0,     0,     0,     0,    12,     0,     0,     1,    11,     0,
       0,    10,     0,     0,     4,     9,     0,     0,     0,     8,
       0,     0,     0,     0,     7,     0,     0,     6,     3,     5,
       2
};
...
{
      13,    -5,     7,     6,    -6,     5,     0,    -6,    -6,    11,
      -1,    -6,    12,     2,    -6,    -6,    14,     3,    15,    -6,
      17,    16,    18,    19,    -6,    20,    21,    -6,    -6,    -6,
      -6
};
...
{
      12,     9,    13,    16,    20,     4,     7,    10,     5,    14,
      17,    18,    21,     6,     1,     8,    22,    25,     2,    23,
      26,    11,    15,     0,    19,     0,     0,    24,    27,    28,
      29,    30
};

static const yytype_int8 yycheck[] =
{
       1,     1,     3,     1,     1,    10,     0,     7,     1,    10,
       8,     9,     9,     6,     1,    10,     1,     1,     5,     4,
       4,    10,    10,    -1,    10,    -1,    -1,    10,    10,    10,
      10,    10
};
...
{
       0,     1,     5,    12,    10,     1,     6,     0,    10,     1,
       7,    10,     1,     3,    10,    10,     1,     8,     9,    10,
       1,     9,     1,     4,    10,     1,     4,    10,    10,    10,
      10
};
...
#line 25 "sintactico.y"
    { yyerrok; printf("Detalle del error: Se esperaba el terminal 'end'"); DibujarTablaDeTokens(); ;}
    break;
...
#line 27 "sintactico.y"
    { yyerrok; printf("Detalle del error: Se esperaba un token del tipo COMPSTMT"); DibujarTablaDeTokens(); ;}
    break;
...
#line 29 "sintactico.y"
    { yyerrok; printf("Detalle del error: Se esperaba un terminal 'do'"); DibujarTablaDeTokens(); ;}
    break;

  case 10:
#line 30 "sintactico.y"
    { yyerrok; printf("Detalle del error: Se esperaba un token del tipo COMMAND"); DibujarTablaDeTokens(); ;}
    break;

  case 11:
#line 31 "sintactico.y"
    { yyerrok; printf("Detalle del error: Token inválido. Quizas debió colocar '='"); DibujarTablaDeTokens(); ;}
    break;
